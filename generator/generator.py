...
"""
	...
	for function in func_list:
		...
		#f.write( function.ret_type + " "+"__wrap_" + function.wraper + "(" + function.arg_string + "){\n")
                f.write("int "+"__wrap_" + function.wraper + "(" + function.arg_string + "){\n\n")
		#f.write("\t" + function.ret_type + " " + "result" + "="  "__real_" + function.wrapee +  "(" + function.string_param_names + ");\n\n")
		f.write("\tpthread_mutex_lock(&log_mutex);\n")
		f.write("\t"+ function.wraper +"_log(" + function.string_param_names + ");\n")
		...
		f.write("\t" + function.wrapee +" " +function.wrapee+"_wrappee= gotcha_get_wrappee(" + function.wrapee  + "_handle);\n\n" )
		f.write("\t" + function.ret_type + " " + "result" + "=" + function.wrapee+"_wrappee(" + function.string_param_names + ");\n\n")

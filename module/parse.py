        ...
        for line in f:
            ...
            if mode=="FUNCTIONS":
                ...
                if len(lst_col_split)==2:
                    ...
                    print("wrap for function \"{0}\" not given".format(functions[-1].name))
...
def main(modulename):
    ...
    generate_wrapper(writable(out_dir, "wrapper.c"), functions, modulename, log_file_nm,\
        include_headers, log_wrap_functions, wrapper_mode, log_pre_wrap_functions)

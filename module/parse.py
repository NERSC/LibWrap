...
def read_config_file(filename):
	...
	return functions, log_wrap_functions, log_pre_wrap_functions, libraries,\
				 log_mpi_finalize_fn,log_file_nm, log_atexit_fn,\
			          		   include_headers, lib_in_make,\
...
def main(modulename):
	...
	functions, log_wrap_functions, log_pre_wrap_functions, libraries, log_mpi_finalize_fn,\

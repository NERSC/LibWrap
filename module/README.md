...
Before executing the MAKEFILE, please execute the static-object-generator.sh script, which will be generated by the generator_static_obj.py. This scripts will help you extract object files from the static libraries (i.e., .a libraries) and will statically link them with your wrapper.
